  ...
  _onCreate(Database db, int version) async {
    ...
    await db.execute('''
       CREATE TABLE IF NOT EXISTS Matchings (
        ...
        Rec1_Donation_Status TEXT NOT NULL CHECK (Donation_Status IN ('Not Started', 'In progress', 'Finished', 'Cancelled')) ,
        Rec2_Donation_Status TEXT NOT NULL CHECK (Donation_Status IN ('Not Started', 'In progress', 'Finished', 'Cancelled')) ,
